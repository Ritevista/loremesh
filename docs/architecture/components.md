...
| `loremesh-tui` | view models, state transitions, Ratatui rendering, interactive grid state, current terminal chart model/text renderer, code/Markdown presentation models | domain mutation, filesystem access, process execution, canonical report formats |
