...
| `loremesh-tui` | view models, state transitions, Ratatui rendering | domain mutation or storage |
| `loremesh` | CLI, use-case orchestration, dependency construction, error context | reusable domain rules |
